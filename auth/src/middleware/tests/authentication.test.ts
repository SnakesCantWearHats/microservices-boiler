...
import { checkUserAndGenNewToken, authentication } from '../authentication';
...
describe('Testing authentication middleware', () => {
	...
	it('Should return error if given password is not correct', async () => {
	...
	it('Should check if user exists, if exists return new token else throw an error', async () => {
